...
convertPrim _ "BEExternalCall" (TText :-> TText :-> TText :-> TText :-> TUpdate TText) =
    let v4 = mkVar "v4"
...
convertPrim _ "UQueryNByKey" (TInt64 :-> _ :-> TUpdate (TList (TTuple2 (TContractId (TCon template)) (TCon template'))))
    | template == template'
